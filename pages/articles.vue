<template>
  <div class="articles-page">
    ...
    <div class="page-container">
      ...
      <p class="articles-page__brief">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
...
export default Vue.extend({
  ...
  async created() {
    const page = this.$route.query.page
    const article = await fetch(`${HOSTNAME}/api/v1/articles?page=${page || 1}`)
      .then((res) => res.json())
